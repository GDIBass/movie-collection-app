 ...
 */
final class Version20181013003049 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mc_movie (id INT NOT NULL, title VARCHAR(255) NOT NULL, release_date DATE NOT NULL, overview LONGTEXT NOT NULL, poster_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
